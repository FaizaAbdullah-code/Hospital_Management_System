...
if (isset($_POST['submit'])) {
    ...
    $contact=$_POST['email'];
    $email=$_POST['age'];
    $password=$_POST['history'];

 
    
    $sql1 = "UPDATE `patient` SET name='$username', contact='$name', address='$address' ,
     contact='$contact' , email='$email'  , age='$password' , history='$password' WHERE id = '$id'";
